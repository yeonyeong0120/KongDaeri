...
| 수집됨 | 기본 | "주워 담았어요" / "찰칵! 주워 담았어요"(스니핑) |
| AI 처리중 | 기본 | "정리 중…" / "번역 중…" |
| 완료 | happy 표정 | "정리 끝!" / "번역 끝!" / "노션에 올렸어요!" |
| 에러 | sad 표정 | "앗, 실패했어요" |
...
- (개선, 미구현) 노션 전송 시 "AI 결과라 부정확할 수 있음" 안내 alert — 현재는 미표시.
...
| AI 부정확 | 저장은 AI와 분리(AI 실패해도 수집은 유지). 노션 확인 안내 alert는 미구현(개선) |
